...
/* package lockServer-0.1.0.0 */
#define VERSION_lockServer "0.1.0.0"
#define MIN_VERSION_lockServer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "lockServer-0.1.0.0-7PbJ57tJ75PIb86aqn1tPz"

#define CURRENT_PACKAGE_KEY "lockServer-0.1.0.0-7PbJ57tJ75PIb86aqn1tPz"
