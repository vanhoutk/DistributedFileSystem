...
/* package DFS-Client-0.1.0.0 */
#define VERSION_DFS_Client "0.1.0.0"
#define MIN_VERSION_DFS_Client(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "DFS-Client-0.1.0.0-C3uuug90Kr53r2JgP5qVKN"

#define CURRENT_PACKAGE_KEY "DFS-Client-0.1.0.0-C3uuug90Kr53r2JgP5qVKN"
