...
/* package fileserverAPI-0.1.0.0 */
#define VERSION_fileserverAPI "0.1.0.0"
#define MIN_VERSION_fileserverAPI(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "fileserverAPI-0.1.0.0-8MHvNKVqWC7GcDn5YWSTZ4"

#define CURRENT_PACKAGE_KEY "fileserverAPI-0.1.0.0-8MHvNKVqWC7GcDn5YWSTZ4"
